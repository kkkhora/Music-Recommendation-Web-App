...
import { getsearch_emotion_range } from '../fetcher'
...
const SearchResult = () => {
    ...
    const filterParams = async (page=1, pagesize=10) => {
        if (location.search.indexOf('?') !== -1) {
            ...
            const { minAcousticness, maxAcousticness, minValence, maxValence, minDanceability, maxDanceability, minEnergy, maxEnergy, minInstrumentalness, maxInstrumentalness, minTempo, maxTempo, happysad } = params
            console.log(minAcousticness, maxAcousticness, minValence, maxValence, minDanceability, maxDanceability, minEnergy, maxEnergy, minInstrumentalness, maxInstrumentalness, minTempo, maxTempo, happysad);
            console.log(happysad);
            let { results,count } = await getsearch_emotion_range( minAcousticness, maxAcousticness, minValence, maxValence, minDanceability, maxDanceability, minEnergy, maxEnergy, minInstrumentalness, maxInstrumentalness, minTempo, maxTempo, happysad,page,pagesize)
                ...
                <div className="container">
                    <div className="section-header">
                        <div className="nft-filter d-flex flex-wrap align-items-center justify-content-center  gap-15">
                            <h3>Search Song by Emotional Range</h3>
                        </div>
                    </div>
